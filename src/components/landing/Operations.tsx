...
import { Box, AlertTriangle, Globe } from 'lucide-react';
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="text-center max-w-3xl mx-auto mb-16">
                    <h2 className="text-3xl sm:text-5xl font-bold text-foreground mb-6">
                        Streamline your <span className="text-primary">Operations</span>
                    </h2>
                    <p className="text-lg text-muted-foreground">
                        Automate the boring stuff so you can focus on growing your business.
                    </p>
                </div>
                    ...
                    <div className="group relative rounded-3xl border border-border bg-card overflow-hidden hover:shadow-2xl hover:shadow-blue-500/5 transition-all duration-500 flex flex-col">
                        <div className="p-8 pb-0 flex-1">
                            ...
                            <p className="text-muted-foreground leading-relaxed text-sm">
                                Get notified instantly about new orders, low stock, and delivery updates via SMS or App notifications.
                            </p>
                        </div>

                        {/* Visual: Notification Stack */}
                        <div className="mt-8 px-6 pb-6 h-48 relative overflow-hidden">
                            <div className="space-y-3 pt-4 group-hover:-translate-y-2 transition-transform duration-500">
                                {/* Notification 1 */}
                                <div className="bg-background border border-border rounded-lg p-3 shadow-sm flex gap-3">
                                    <div className="w-8 h-8 rounded-full bg-green-100 flex items-center justify-center text-green-600 shrink-0"><Box className="w-4 h-4" /></div>
                                    <div className="flex-1 min-w-0">
                                        <p className="text-xs font-semibold text-foreground">New Order #8821</p>
                                        <p className="text-[10px] text-muted-foreground">Ram Sharma ordered Nike Air Max...</p>
                                    </div>
                                    <span className="text-[10px] text-muted-foreground">2m</span>
                                </div>
                                {/* Notification 2 */}
                                <div className="bg-background border border-border rounded-lg p-3 shadow-sm flex gap-3 opacity-80">
                                    <div className="w-8 h-8 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 shrink-0"><Box className="w-4 h-4" /></div>
                                    <div className="flex-1 min-w-0">
                                        <p className="text-xs font-semibold text-foreground">Delivery Update</p>
