...
const tabs = [
    {
        ...
        desc: "Process orders from all channels in one place. Print shipping labels and track deliveries automatically.",
        icon: ShoppingBag,
        color: "text-blue-600",
    ...
    },
    {
        ...
        subtitle: "Insightful",
        desc: "Real-time data on your best selling products, peak hours, and customer retention rates.",
        icon: BarChart3,
    ...
    },
    {
        ...
        subtitle: "Secure",
        desc: "Invite your staff with role-based access. Track who fulfilled which order and when.",
        icon: Users,
                                ...
                                <div className="flex items-start gap-4 relative z-10">
                                    <div
                                        className={cn(
                                            ...
                                            activeTab === tab.id ? tab.bg : "bg-muted"
                                        )}
                                    >
                                        <tab.icon
                                            className={cn(
                    ...
                    <div className="lg:col-span-7">
                        <div className="relative rounded-2xl border border-border bg-background shadow-2xl overflow-hidden h-[600px] flex flex-col">
                            ...
                            <div className="h-14 border-b border-border bg-muted/30 flex items-center px-4 justify-between shrink-0">
                                ...
                                <div className="bg-background border border-border rounded-md px-3 py-1 text-xs text-muted-foreground flex items-center gap-2 shadow-sm sm:flex">
                                        ...
                                        <div className="bg-card rounded-xl border border-border shadow-sm overflow-hidden flex-1">
                                            ...
                                            <div className="divide-y divide-border">
                                                {[
                                                    ...
                                                    <div
                                                        key={i}
                                                        className="px-4 py-4 flex items-center gap-4 hover:bg-muted/30 transition-colors group cursor-pointer"
                                                    >
                                                        <div className="flex-1 font-mono text-xs font-medium text-primary">
                                                            {order.id}
                                                        </div>
                                    ...
                                    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 h-full flex flex-col">
                                        <div className="flex justify-between items-center mb-6">
                                            ...
                                            <div className="flex bg-muted rounded-lg p-1">
                                                <button className="px-3 py-1 text-xs font-medium rounded-md bg-background shadow-sm text-foreground">
                                                    7 Days
                                                </button>
                                                <button className="px-3 py-1 text-xs font-medium rounded-md text-muted-foreground hover:text-foreground">
                                                    30 Days
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div className="grid grid-cols-2 gap-4 mb-6">
                                            <div className="bg-card p-4 rounded-xl border border-border shadow-sm">
                                                ...
                                                <h3 className="text-2xl font-bold text-foreground flex items-end gap-2">
                                                    Rs 2.4L{" "}
                                                    <span className="text-xs font-medium text-green-600 mb-1 bg-green-500/10 px-1.5 rounded">
                                                        +12%
                                                    </span>
                                                </h3>
                                            </div>
                                    ...
                                    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 h-full flex flex-col">
                                        ...
                                        <div className="bg-card rounded-xl border border-border shadow-sm overflow-hidden">
                                            {[
                                                ...
                                                <div
                                                    key={i}
                                                    className="p-4 border-b border-border last:border-0 flex items-center justify-between hover:bg-muted/20"
                                                >
                                        ...
                                        <div className="mt-6 bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border border-blue-100 dark:border-blue-800 flex gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-xs text-blue-600/80 dark:text-blue-300/70 mt-1">
                                                    You can now assign granular permissions for inventory
                                                    management and financial reports to specific roles.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
