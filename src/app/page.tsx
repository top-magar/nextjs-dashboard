  ...
  return (
    <main className="flex min-h-screen flex-col p-6">
      ...
      <div className="mt-4 flex grow flex-col gap-4 md:flex-row">
        <div className="flex flex-col justify-center gap-6 rounded-lg bg-muted/40 px-6 py-10 md:w-2/5 md:px-20">
          ...
          <p className={`${displayFont.className} text-xl text-foreground md:text-3xl md:leading-normal`}>
